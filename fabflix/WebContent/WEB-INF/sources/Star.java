...
public class Star {
	...
	public String stageNm = Tools.ukw; //combination of first and last name of star
	...
	/*
    	...
    	public int getStarMovieId() {
        return m.id;
	    }
	    public void setStarMovieId(int mvid_) {
	        this.m.id = mvid_;
	    }
	    ...
	    public String getStarMovieTitle() {
	        return m.title;
	    }
	    public void setStarMovieTitle(String ttl_) {
	        this.m.title = ttl_;
	    }
 */
