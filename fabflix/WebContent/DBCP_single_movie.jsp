...
Enter Quantity:
 <p><input type="number" name="qte" min ="1" value="1" placeholder="Enter Quantity"></p>
 <p><input type="hidden" name="mvId"  value="<%=mvId%>" ></p>
 <p><input type="hidden" name="mvTitle"  value="<%=title%>" ></p>
 <p><input type="hidden" name="mvBan"  value="<%=banner%>" ></p>
