...
public class Bt2Servlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Movie> movieList = g.searchMvGenre(mTitle,(pg-1)*nRowsToDisplay,nRowsToDisplay);
        ...
        //RequestDispatcher show = request.getRequestDispatcher("/browse_t_g.jsp");
        RequestDispatcher show = request.getRequestDispatcher("/browsing.jsp");
