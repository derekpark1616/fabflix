...
public class SGInMovies {
	...
	/*
	 * public String getStarFName() { return fname; } public void
	 * setStarFName(String fname_) { this.fname = fname_; }
	 * 
	 * public String getStarLName() { return lname; } public void
	 * setStarLName(String lname_) { this.lname = lname_; }
	 */
