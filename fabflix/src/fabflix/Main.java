	...
	public static void main(String[] args) {
		...
		if (DB.dbcon == null) {
			try {
				...
				System.out.println("\nNow Updating all records... please wait...");// Now
																					// Updating
																					// all
																					// records...
