...
public class Movie {
	...
	// public List <Map<String, String>> star = new ArrayList<Map<String,
	// String>>();
	// public List<String> stars = new ArrayList<String>();

	/*
	 * public Movie (int id_, String title_, int year_, String director_, String
	 * bannerUrl_, String genre_, List <Map<String, String>> star_){ id = id_;
	 * title = title_; year = year_; director = director_; bannerUrl =
	 * bannerUrl_; genre = genre_; star = star_; }
	 */
	...
	public Movie(Integer id_, String title_, Integer year_, String director_, String bannerUrl_, Genre genre_,
			Star star_) {
		id = id_;
		title = title_;
		year = year_;
