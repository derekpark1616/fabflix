...
public class DBCP_MovieProcess {
	...
	public void insertQuantity(int movieId, int qt) {
		...
		try {
			...
			PreparedStatement quantiyInsert = connection.prepareStatement(
	...
	public List<Movie> searchMovies(String title, String yr, String director, String star, int offset,
		...
		try {
			...
			connection = dbs.getConnection(DB.poolEnabled, 0); // now we are all
																// set to fire
																// queries and
																// fetch the
																// results
	...
	public void emptyCart() throws Exception {
		...
		PreparedStatement getCustId = connection
