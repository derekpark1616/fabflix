...
public class InsertStarServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			PreparedStatement starinsert = DB.dbcon.prepareStatement(
		...
		// String encodedURL =
		// response.encodeRedirectURL("../_dashboard//empDashboard.jsp");
		// response.sendRedirect(encodedURL);
		 ...
		 * request.getRequestDispatcher("/displayMovieList.jsp");
		 * RequestDispatcher show =
		 * request.getRequestDispatcher("/insertStar.jsp"); //RequestDispatcher
		 * show = request.getRequestDispatcher("movie.go");
