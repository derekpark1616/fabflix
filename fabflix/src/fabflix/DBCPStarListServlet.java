...
/**
 * Servlet implementation class DBCPStarListServlet
 */
@WebServlet(description = "Search for Star DBCP", urlPatterns = { "/DBCPStarListServlet" })
public class DBCPStarListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DBCPStarListServlet() {
        super();
