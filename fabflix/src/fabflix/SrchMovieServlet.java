...
public class SrchMovieServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String year = null;
		/*
		 * System.out.println(yr); System.out.println(director);
		...
		/*
		 * if(!mT.equals("")){ mTitle = "%" + mT + "%"; } if(!yr.equals("")){
		 * year = "%" + yr + "%"; } if(!dr.equals("")){ director = "%" + dr +
		 * "%"; } if(!sr.equals("")){ stare = sr; }
		 */
		...
		List<Movie> movieList = g.searchMovies(mTitle, year, director, stare, (pg - 1) * nRowsToDisplay,
				nRowsToDisplay);
