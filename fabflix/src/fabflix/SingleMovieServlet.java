...
public class SingleMovieServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		/*
		 * title = movieInfo.getMovieTitle(); director =
		 * movieInfo.getMovieDirector(); banner = movieInfo.getMovieBanner();
		 * trailerUrl = movieInfo.getMovieTrailer();
		 * 
		 * gr = movieInfo.getMovieGenreName(); stFn =
		 * movieInfo.getMovieStarFn(); stLn = movieInfo.getMovieStarLn(); stPh =
		 * movieInfo.getMovieStarPhoto();
		 * 
		 */
