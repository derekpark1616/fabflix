	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Integer> cartContaint = new ArrayList<>();
			...
			try {
				...
				PreparedStatement salesInsert = DB.dbcon.prepareStatement( "INSERT INTO `sales` (`customer_id`,`movie_id`,`sale_date`) VALUES (?,?,?)");
				...
				if (cc.next()) {
				    do {
				    	...
				    	for (int m:cartContaint){
							...
							salesInsert.executeUpdate();		// Store into our Database the Credit Card info
						}
